...
public class DesignScroll extends BasicScrollBarUI {

    private final int THUMB_SIZE = 50;//velicina scrolla
    ...
    protected void paintTrack(Graphics grphcs, JComponent jc, Rectangle rctngl) {
        ...
        g2.setColor(new Color(240, 240, 240));//boja pozadine celog scroll bara
